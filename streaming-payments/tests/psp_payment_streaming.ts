...
describe("Streaming Payments tests", () => {
  ...
  it.only("Create and Spend Program Utxo", async () => {
    ...
    const lightProvider = await LightProvider.init({ wallet, url: RPC_URL, relayer, confirmConfig });
    ...
    const txParams = new TransactionParameters({
      ...
      transactionMerkleTreePubkey: MerkleTreeConfig.getTransactionMerkleTreePda(new BN(0)),
