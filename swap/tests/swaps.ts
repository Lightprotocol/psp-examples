...
class Swap {
  ...
  static async create(
    ...
    const swapParameters: SwapParameters = {
      ...
      amountFrom,
      amountTo,
      swapTakerCommitmentHash: BN_ZERO,
      userPubkey: BN_ZERO,
    };
  ...
  async createSwap(
    ...
    const serializationObject = {
      ...
      accountEncryptionPublicKey:
        this.swap.programUtxo.account.encryptionKeypair.publicKey,
      accountShieldedPublicKey: this.swap.programUtxo.account.pubkey,
    };
    const utxoBytes = (
  ...
  async execute(programUtxo?: Utxo) {
    ...
    const programParameters: ProgramParameters = {
      inputs: {
        ...
        isTakerOutUtxo: [[BN_ZERO, BN_ONE, BN_ZERO, BN_ZERO]],
      },
      verifierIdl: IDL,
      path: circuitPath,
      accounts: {
